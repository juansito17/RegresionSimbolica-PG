"""Default AlphaSymbolic estimator runner for the pinned SRBench harness.
...
def _candidate_summary(model: AlphaSymbolicRegressor) -> list[Mapping[str, Any]]:
    result = []
...
def run(prepared: Any, context: Any) -> Mapping[str, Any]:
    """Fit AlphaSymbolic and return predictions in scaled target coordinates."""
    ...
    estimator = AlphaSymbolicRegressor(**params)
