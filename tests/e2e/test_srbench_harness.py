...
from warpsymbolic.cli.benchmark_srbench import (
    DEFAULT_MANIFEST,
    DatasetSpec,
    ExecutionPlan,
    ProtocolError,
...
from warpsymbolic.cli import srbench_runner
...
def test_default_runner_applies_context_budgets_and_returns_cached_model(monkeypatch):
    ...
    monkeypatch.setattr(srbench_runner, "WarpSymbolicRegressor", FakeEstimator)
