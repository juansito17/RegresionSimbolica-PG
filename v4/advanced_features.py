...
from globals import INF, MUTATION_RATE, ELITE_PERCENTAGE
...
class EvolutionParameters:
    def __init__(self):
        ...
        self.tournament_size = 20  # Más presión selectiva
        self.crossover_rate = 0.9  # Cruce más frecuente
    @staticmethod
    def create_default():
        return EvolutionParameters()
    def mutate(self):
        # Slight random change to parameters
