"""
Search/Solve functions for WarpSymbolic Gradio App.
...
from warpsymbolic.symbolic.detect_pattern import detect_pattern
from warpsymbolic.symbolic.optimize_constants import optimize_constants, substitute_constants
