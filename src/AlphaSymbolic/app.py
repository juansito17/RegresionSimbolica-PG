"""
WarpSymbolic - Gradio Web Interface
...
# ``warpsymbolic/api/sklearn.py`` is the public adapter; when this file is run as
...
def create_app(verbose=False):
    ...
    with gr.Blocks(title="WarpSymbolic") as demo:
        ...
        with gr.Tabs():
                ...
                with gr.Row():
                    ...
                    with gr.Column(scale=1, min_width=360, elem_classes="as-sidebar"):
                        ...
                        search_method = gr.Radio(
                            choices=["WarpSymbolic Adaptive"],
                            value="WarpSymbolic Adaptive",
            ...
            with gr.Tab("Informacion"):
                ...
                <div style="background: #1a1a2e; padding: 30px; border-radius: 15px;">
                    <h2 style="color: #00d4ff;">Que es WarpSymbolic?</h2>
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description="WarpSymbolic Gradio UI")
    ...
    logger.info("Iniciando WarpSymbolic...")
    ...
    open_browser = os.environ.get(
        "WARPSYMBOLIC_NO_BROWSER",
        os.environ.get("ALPHASYMBOLIC_NO_BROWSER", "0"),
    ) != "1"
    ...
    configure_logging()
    logger.info("WarpSymbolic importado como módulo.")
