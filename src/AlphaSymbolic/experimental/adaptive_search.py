"""Training-data-only adaptive search for :class:`WarpSymbolicRegressor`.
...
from warpsymbolic.api.estimator import (
    _AdaptiveCandidate,
    _format_number,
...
def fit_adaptive(estimator: Any, X: Any, y: Any):
    ...
    engine_is_warm = "warpsymbolic.gpu.engine" in sys.modules
