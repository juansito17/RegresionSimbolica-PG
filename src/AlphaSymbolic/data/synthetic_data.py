...
from warpsymbolic.symbolic.grammar import ExpressionTree, OPERATORS, CONSTANTS, VARIABLES
...
class DataGenerator:
    ...
    def generate_inverse_batch(self, batch_size: int, point_count: int = 10) -> List[Dict[str, Any]]:
        ...
        In WarpSymbolic terminology, 'inverse' refers to the formula itself.
        """
