...
globals_code = [
    ...
    "INITIAL_FORMULA_STRING = \"((((x+(x%(7.14937743-(-1.53627077^x))))+(4.98708598%x))*x)*0.0274748)\" # @param {type:\"string\"}",
    "",
    ...
    "// Order: +, -, *, /, ^, %, s, c, l, e, !, _, g",
    "const std::vector<double> OPERATOR_WEIGHTS = {{0.10, 0.15, 0.10, 0.10, 0.05, 0.01, 0.01, 0.01, 0.15, 0.02, 0.05, 0.05, 0.20}};",
    "",
    "// Fitness & Other",
