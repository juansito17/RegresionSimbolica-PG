...
globals_code = [
    ...
    "",
    "# Problem Data",
    "TARGETS_STR = \"92, 352, 724\" # @param {type:\"string\"}",
    "X_VALUES_STR = \"8, 9, 10\" # @param {type:\"string\"}",
    "",
    "# Algorithm Settings",
    ...
    "INITIAL_FORMULA_STRING = \"x\" # @param {type:\"string\"}",
    "",
    ...
    "",
    "// Data",
    "const std::vector<double> TARGETS = {{ {TARGETS_STR} }};",
    ...
    "const int MAX_TREE_DEPTH_MUTATION = 6;",
    "",
    "// Tree Generation",
    "const int MAX_TREE_DEPTH_INITIAL = 6;",
    ...
    "",
    "// Fitness & Other",
    "const double COMPLEXITY_PENALTY_FACTOR = 0.005;",
