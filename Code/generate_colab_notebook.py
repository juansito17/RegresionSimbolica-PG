...
globals_code = [
    ...
    "",
    "# Tree Depth Limits",
    "USE_HARD_DEPTH_LIMIT = True # @param {type:\"boolean\"}",
    "MAX_TREE_DEPTH_HARD_LIMIT = 12 # @param {type:\"integer\"}",
    "",
    "# Genetic Operators",
    ...
    "PREVENT_DUPLICATES = True # @param {type:\"boolean\"}",
    "DUPLICATE_RETRIES = 10 # @param {type:\"integer\"}",
    ...
    "const bool USE_HARD_DEPTH_LIMIT = {'true' if USE_HARD_DEPTH_LIMIT else 'false'};",
    "const int MAX_TREE_DEPTH_HARD_LIMIT = {MAX_TREE_DEPTH_HARD_LIMIT};",
    ...
    "const bool PREVENT_DUPLICATES = {'true' if PREVENT_DUPLICATES else 'false'};",
    "const int DUPLICATE_RETRIES = {DUPLICATE_RETRIES};",
